    ...
    for channel in channels:
        ...
        for key in branches.keys():
            if branches.typenames()[key] in ["int32_t", "float"]:
                ...
                selected_array = selected_array.loc[(selected_array["Sample"] == "qqZllH125")|(selected_array["Sample"] == "ggZllH125")|(selected_array["Sample"] == "ggZllH125cc")|(selected_array["Sample"] == "qqZllH125cc")]
